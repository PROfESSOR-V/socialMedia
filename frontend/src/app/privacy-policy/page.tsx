...
export const metadata: Metadata = {
  title: 'Privacy Policy - AÚRELYÑ',
  description: 'Privacy Policy for AÚRELYÑ.',
};

export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-16 pt-32 max-w-4xl">
      <h1 className="font-serif text-4xl mb-8 text-center text-zinc-900">Privacy Policy</h1>
      
      <div className="prose prose-zinc max-w-none text-zinc-600 space-y-6">
        <p>
          AÚRELYÑ operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). AÚRELYÑ is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
        </p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Personal Information We Collect or Process</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Personal Information Sources</h2>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">How We Use Your Personal Information</h2>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">How We Disclose Personal Information</h2>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Children's Data</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Security and Retention of Your Information</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Your Rights and Choices</h2>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Complaints</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">International Transfers</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Changes to This Privacy Policy</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold text-zinc-800 mt-8 mb-4">Contact</h2>
        <p>
          Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at <a href="mailto:piyushdakhlani76@gmail.com" className="text-blue-600 hover:underline">piyushdakhlani76@gmail.com</a> or contact us at Tijara Bus Depo, Near Old Water Tank, Tijara, RJ, 301411, IN
        </p>
      </div>
    </div>
  );
