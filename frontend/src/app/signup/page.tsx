...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await apiClient.post("/auth/signup", { mobileNumber, password });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fefdfb] px-4 py-12 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-[0_0_40px_-10px_rgba(0,0,0,0.05)] border border-black/5 relative overflow-hidden">
        ...
        <div className="absolute left-0 bottom-0 -ml-16 -mb-16 w-32 h-32 bg-amber-50 rounded-full blur-3xl opacity-50" />
        ...
        <div className="relative z-10">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-2xl font-serif text-zinc-900 mb-2">Create an account</h2>
            <p className="text-sm text-zinc-500">
              Join us to discover our exclusive collections
            </p>
          </div>
          ...
          <div className="mt-8 text-center pt-6 border-t border-zinc-100">
            <p className="text-sm text-zinc-600">
              ...
              <Link href="/login" className="font-medium text-black hover:underline underline-offset-4 transition-all">
                Sign in
              </Link>
            </p>
          </div>
